...
-   [Map of MBON Activities - Upload Form](https://docs.google.com/forms/d/e/1FAIpQLScEGBgY0liaIjY3cT4Celzz6XbU72NfMNo_U89TtKMU7G-s_g/viewform?usp=sf_link)\
    ...
    code: [process_goosocean.R](https://github.com/marinebon/map-of-activities/blob/main/lib/process_goosocean.R) → [p2p.geojson](https://github.com/marinebon/map-of-activities/blob/main/data/p2p.geojson)
...
-   [Search for "MBON" - GOOS BioEco GeoNode](https://geonode.goosocean.org/search/?title__icontains=MBON&abstract__icontains=MBON&purpose__icontains=MBON&f_method=or&limit=5&offset=0)\
    ...
    code: [process_uploads.R](https://github.com/marinebon/map-of-activities/blob/main/lib/process_uploads.R) → [sbc.geojson](https://github.com/marinebon/map-of-activities/blob/main/data/sbc.geojson), [sfl.geojson](https://github.com/marinebon/map-of-activities/blob/main/data/sfl.geojson)
